 ...
 *
 * @return a pair containing the resolved [Node], and a list of warnings.
 */
  ...
  return when (this) {
    ...
    is MapNode -> when (other) {
      ...
      is MapNode -> {
        ...
        CascadeResult(MapNode(map, this.pos, this.path, this.value.cascade(other.value, cascadeMode).node), overrides)
      }
