  ...
  override fun safeDecode(node: Node, type: KType, context: DecoderContext): ConfigResult<Any> {
    ...
    return constructor.flatMap { constr ->
      ...
      if (node is Undefined) {
        ConfigFailure.UndefinedForNonNullField.invalid()
      } else {
...
@Deprecated("Inline classes have been deprecated in Kotlin 1.5 in favour of value classes")
