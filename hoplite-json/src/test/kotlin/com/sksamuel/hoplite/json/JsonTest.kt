  ...
  init {
    ...
    test("parsing basic json") {
      JsonParser().load(javaClass.getResourceAsStream("/basic.json"), source = "a.json") shouldBe
        MapNode(
          mapOf(
            "a" to StringNode(value = "hello", pos = LineColPos(line = 2, col = 15, source = "a.json"), dotpath = ""),
            "b" to LongNode(value = 1, pos = LineColPos(line = 3, col = 3, source = "a.json"), dotpath = ""),
            "c" to BooleanNode(value = true, pos = LineColPos(line = 4, col = 12, source = "a.json"), dotpath = ""),
            "d" to DoubleNode(value = 2.3, pos = LineColPos(line = 5, col = 11, source = "a.json"), dotpath = "")
          ),
      ...
      JsonParser().load(javaClass.getResourceAsStream("/nested_basic_arrays.json"), source = "a.json") shouldBe
        MapNode(
          mapOf(
            ...
            "b" to ListNode(
              elements = listOf(
                StringNode(value = "x", pos = LineColPos(line = 4, col = 8, source = "a.json"), dotpath = ""),
                StringNode(value = "y", pos = LineColPos(line = 5, col = 8, source = "a.json"), dotpath = ""),
                StringNode(value = "z", pos = LineColPos(line = 6, col = 8, source = "a.json"), dotpath = "")
              ),
          ...
          mapOf(
            ...
            "b" to ListNode(
              elements = listOf(
                ...
                MapNode(
                  map = mapOf(
                    "e" to DoubleNode(value = 1.4,
                      pos = LineColPos(line = 9, col = 15, source = "a.json"),
                      dotpath = ""),
                    "f" to LongNode(value = 4,
